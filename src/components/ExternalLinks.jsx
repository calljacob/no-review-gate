        ...
        <div className="w-full animate-fade-in">
            <div className="grid gap-4 md:grid-cols-2">
                {googleLink && (
                    <a
                        ...
                        className="flex items-center justify-center gap-3 p-4 bg-white text-slate-900 rounded-xl 
            hover:bg-slate-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group"
                    >
                ...
                {yelpLink && (
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-3 p-4 bg-[#ff1a1a] text-white rounded-xl 
            hover:bg-[#e60000] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group"
                    >
                        ...
                        <span className="font-bold text-lg">Yelp</span>
                        <ExternalLink className="w-4 h-4 opacity-50 group-hover:opacity-100 transition-opacity ml-auto" />
                    </a>
                )}
            </div>
